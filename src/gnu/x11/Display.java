...
public class Display
{
  ...
  public static class Name
  {
    ...
    public Name(String display_name)
    {
      ...
      if (j == - 1)
        {
          ...
          display_no = Integer.parseInt(display_name.substring(
                                                               i + 1,
                                                               display_name.length()));
          return;
        }
      ...
      screen_no = Integer.parseInt(display_name.substring(j + 1,
                                                          display_name.length()));
    }
   ...
   */
  public void set_screen_saver(int timeout, int interval, int prefer_blanking,
                               int allow_exposures)
  {
      ...
      throws EscherServerConnectionException
  {
    ...
    switch (accepted)
      ...
      case 0:
        ...
        debugMessage.append("permissions (eg. edit .Xauthority or run "
                            + "\"xhost +\")\n");
        debugMessage.append("NOTE: leaving \"xhost +\" and allowing remote "
                            + "tcp\n");
        ...
        if (DEBUG)
          {
            ...
            debugMessage.append("XServer are allowed to use non standard "
                                + "errors codes\n");
            debugMessage.append("Please, consult the manual of your XServer\n"
                                + "to map the error codes to human readable\n"
                                + "values.\n");
          }
    ...
    extended_maximum_request_length = maximum_request_length = i.read_int16();
        ...
        try
          {
            if (auth.hostname != null
                ...
                && InetAddress.getByName(auth.hostname).equals(
    ...
    try
    ...
    catch (Error e)
      {
        ...
        try
          ...
          {
            throw new java.lang.Error("Failed to clear socket input stream: "
                                      + ie);
          }
